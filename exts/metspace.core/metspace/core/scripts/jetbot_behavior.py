...
from .commands.robot_goto import Robot_GoTo
from .commands.robot_idle import Robot_Idle
from .commands.robot_track import Robot_Track
from .commands.robot_policy import Robot_policy
from .track_manager import TrackManager
from .models.get_model import get_model
from metspace.core.stage_util import RobotUtil
"""
...
class JetbotBehavior(BehaviorScript):
    def on_init(self):
        ...
        self._linear_speed = 1.5
        self._angular_speed = 0.350
    ...
    def set_up_robot(self, wheel_joints, wheel_radius, wheel_base):
        ...
        # get specific camera on the robot
        self._camera_prim = RobotUtil.get_specific_cameras_on_robot(robot_prim_path=self.prim_path.pathString)[0]
    ...
    def get_command(self, command):
        ...
        if command[0] == "Track":
            return Robot_Track(self._wheeled_robot, self._controller, command, self.navigation_manager)
        elif command[0] == "Policy":
            model_type = command[-1]
            model = get_model(model_type)
            return Robot_policy(self._wheeled_robot, self._controller, self._camera_prim, model, self._linear_speed, self._angular_speed)
